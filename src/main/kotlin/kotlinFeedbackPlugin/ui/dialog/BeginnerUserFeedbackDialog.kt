...
import kotlinFeedbackPlugin.user.BeginnerUserType as BeginnerUserType1

/**
 * Feedback dialog for beginner user type.
 *
 * @see kotlinFeedbackPlugin.user.BeginnerUserType1
 */
...
class BeginnerUserFeedbackDialog(project: Project) : AttachedFileFeedbackDialog(project) {
    ...
    init {
        myOKAction = sendFeedbackAction(BeginnerUserType1)
