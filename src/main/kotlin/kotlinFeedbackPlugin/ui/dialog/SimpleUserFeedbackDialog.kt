 ...
 *
 * @see kotlinFeedbackPlugin.user.SimpleUserType
 */

class SimpleUserFeedbackDialog(project: Project) : AttachedFileFeedbackDialog(project) {
    ...
    init {
        myOKAction = sendFeedbackAction(SimpleUserType)
